...
from pyramid_rollers.util import func_name, is_string, to_list
from pyramid_rollers.validators import (
    DEFAULT_FILTERS,
    DEFAULT_VALIDATORS,
)
...
class Service(object):
    ...
    def __init__(
        ...
        **kw,
        ...
        def callback(context, name, ob):
            ...
            config.add_pyramid_rollers_service(self)
    ...
    def default_error_handler(self, request):
        ...
        :class:`pyramid_rollers.renderer.PyramidRollersRenderer`.
    ...
    def add_view(self, method, view, **kwargs):
        ...
        :meth:`~pyramid_rollers.service.Service.api` has following keyword params:
...
def decorate_view(view, args, method, route_args={}):
    """Decorate a given view with pyramid-rollers niceties.
    ...
    def wrapper(request):
        ...
        request.pyramid_rollers_args = (args, ob)
        return response
