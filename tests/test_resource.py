...
from pyramid_rollers.resource import resource, view
...
class TestResource(TestCase):
    ...
    @mock.patch("pyramid_rollers.resource.Service")
    ...
    def test_service_wrapped_resource(self):
        ...
        for name, service in (
            (x.name, x)
            for x in self.config.registry.pyramid_rollers_services.values()
