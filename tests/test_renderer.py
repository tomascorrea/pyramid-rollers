...
from pyramid_rollers import PyramidRollersRenderer
from pyramid_rollers.renderer import JSONError, bytes_adapter
...
class TestRenderer(TestCase):
    def test_renderer_is_pyramid_renderer_subclass(self):
        self.assertIsInstance(PyramidRollersRenderer(), JSON)

    def test_renderer_has_bytes_adapter_by_default(self):
        renderer = PyramidRollersRenderer()
        self.assertEqual(
