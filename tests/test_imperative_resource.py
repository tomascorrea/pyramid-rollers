...
from pyramid_rollers.resource import add_resource, add_view
...
class TestResource(TestCase):
    def setUp(self):
        ...
        self.config.add_pyramid_rollers_resource(thing_resource)
        self.config.add_pyramid_rollers_resource(user_resource)
